...
def test_aggregate_vehicle_counts(pipeline):
    df = pd.DataFrame({
        "Personenwagen": [10], "Personenwagen mit anhänger": [2],
        "Lieferwagen": [5], "Lieferwagen mit anhänger": [1],
        "Lieferwagen mit auflieger": [0], "Lastwagen": [3],
        "Lastwagen mit anhänger": [1], "sattelzug": [1],
        "Motorrad": [2], "bus": [1]
    })
